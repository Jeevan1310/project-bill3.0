			...
			<div class="col-md-4">
				<div class="card mx-auto profile-card">
					<div class="profile-image">
						<?php
							// Define the image file based on user type
							$imageFile = '';
							if ($user_type === 'Admin') {
								$imageFile = 'admin.png';
							} elseif ($user_type === 'Superadmin') {
								$imageFile = 'superadmin.png';
							} else {
								$imageFile = 'user.png';
							}
						?>
						<img class="card-img-top mx-auto" src="./images/<?php echo $imageFile; ?>" alt="Profile Image">
					</div>
					<div class="card-body">
						<h4 class="card-title">User Profile</h4>
						<div class="profile-details">
							<p><i class="fa fa-user"></i> <?php echo $username; ?></p>
							<p><i class="fa fa-shield"></i> <?php echo $user_type; ?></p>
					...
					<div class="col-md-4">
						<div class="card">
							<div class="card-body">
								...
								<p class="card-text">Here you can manage users in the system</p>
